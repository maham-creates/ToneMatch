    ...
    useEffect(() => {
        if (isWebcamActive) {
            initializeFaceMeshVideo((detectedLandmarks) => {
                ...
                // Detect skin tone once when face is first detected
        ...
        <main className="min-h-screen p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <header className="text-center mb-12 animate-fade-in">
                    <h1 className="text-5xl font-bold gradient-text mb-4">ToneMatch</h1>
                    <p className="text-gray-400 text-lg">
                        AI-Powered Virtual Makeup Try-On
                    </p>
                    <p className="text-gray-500 text-sm mt-2">
                        Start your camera • Get personalized recommendations • Try makeup in real-time
                    </p>
                </header>
